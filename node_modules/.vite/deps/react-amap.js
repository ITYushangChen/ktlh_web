...
// node_modules/react-amap/lib/utils/APILoader.js
var require_APILoader = __commonJS({
  "node_modules/react-amap/lib/utils/APILoader.js"(exports) {
    "use strict";
    ...
    var APILoader = function() {
      function APILoader2(_ref) {
        var key = _ref.key, useAMapUI = _ref.useAMapUI, version = _ref.version, protocol = _ref.protocol;
        _classCallCheck(this, APILoader2);
        this.config = _extends({}, DEFAULT_CONFIG, { useAMapUI, protocol });
...
// node_modules/react-amap/lib/utils/isFun.js
var require_isFun = __commonJS({
  "node_modules/react-amap/lib/utils/isFun.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var isFun = function isFun2(arg) {
...
// node_modules/react-amap/lib/utils/log.js
var require_log = __commonJS({
  "node_modules/react-amap/lib/utils/log.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/react-amap/lib/utils/common.js
var require_common = __commonJS({
  "node_modules/react-amap/lib/utils/common.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var hasWindow = typeof window !== "undefined";
    var toLnglat = exports.toLnglat = function toLnglat2(pos) {
      if (!pos) {
        return pos;
      }
    ...
    var toPixel = exports.toPixel = function toPixel2(ofst) {
      if (!ofst) {
        return ofst;
      }
    ...
    var toSize = exports.toSize = function toSize2(size) {
      if (!size) {
        return size;
      }
      if ("getWidth" in size) {
...
// node_modules/react-amap/lib/utils/toCapitalString.js
var require_toCapitalString = __commonJS({
  "node_modules/react-amap/lib/utils/toCapitalString.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var toCapitalString = function toCapitalString2(str) {
...
// node_modules/react-amap/lib/utils/withPropsReactive.js
var require_withPropsReactive = __commonJS({
  "node_modules/react-amap/lib/utils/withPropsReactive.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _toCapitalString = require_toCapitalString();
      ...
      return function(_React$Component) {
        ...
        _createClass(_class, [{
          ...
          value: function createEventsProxy(props) {
            ...
            evs.length && evs.forEach(function(ev) {
              if (self.registeredEvents.indexOf(ev) === -1) {
                ...
                instance.on(ev, /* @__PURE__ */ function(ev2) {
                  return function() {
                    if (self.props.events && ev2 in self.props.events) {
                      for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
                        args[_key] = arguments[_key];
                      }
                      self.props.events[ev2].apply(null, args);
                    }
                  };
                }(ev));
              }
          ...
          value: function reactivePropChange(nextProps) {
            var _this2 = this;
            var shouldDetectChange = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
            if (!this.instanceCreated) {
              return false;
            }
            var _myMapComponent = this.myMapComponent, _myMapComponent$sette = _myMapComponent.setterMap, setterMap = _myMapComponent$sette === void 0 ? {} : _myMapComponent$sette, _myMapComponent$conve = _myMapComponent.converterMap, converterMap = _myMapComponent$conve === void 0 ? {} : _myMapComponent$conve, _myMapComponent$insta = _myMapComponent.instance, instance = _myMapComponent$insta === void 0 ? {} : _myMapComponent$insta;
...
var require_map = __commonJS({
  "node_modules/react-amap/lib/map/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var BaseMap = function(_Component) {
      _inherits(BaseMap2, _Component);
      function BaseMap2(props) {
        _classCallCheck(this, BaseMap2);
        var _this = _possibleConstructorReturn(this, (BaseMap2.__proto__ || Object.getPrototypeOf(BaseMap2)).call(this, props));
        _this.state = {
          mapLoaded: false
        };
        var self = _this;
      ...
      _createClass(BaseMap2, [{
          ...
          if ("plugins" in props) {
            ...
            if (plugins && plugins.length) {
              plugins.forEach(function(p) {
                var name = void 0, config = void 0, visible = void 0;
                if (typeof p === "string") {
                  name = p;
                  config = null;
                  visible = true;
        ...
        value: function setMapPlugin(name, opts) {
          ...
          if (this.pluginMap[name]) {
            ...
            var onCreated = opts.onCreated, restOpts = _objectWithoutProperties(opts, ["onCreated"]);
...
// node_modules/react-amap/lib/utils/markerUtils.js
var require_markerUtils = __commonJS({
  "node_modules/react-amap/lib/utils/markerUtils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.renderMarkerComponent = exports.getPropValue = exports.MarkerAllProps = exports.MarkerConfigurableProps = void 0;
    var _common = require_common();
    var _react = require_react();
    var _react2 = _interopRequireDefault(_react);
    ...
    var getPropValue = exports.getPropValue = function getPropValue2(key, value) {
    ...
    var renderMarkerComponent = exports.renderMarkerComponent = function renderMarkerComponent2(component, marker) {
      var child = component;
...
// node_modules/react-amap/lib/marker/index.js
var require_marker = __commonJS({
  "node_modules/react-amap/lib/marker/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _withPropsReactive = require_withPropsReactive();
    var _withPropsReactive2 = _interopRequireDefault(_withPropsReactive);
    var _markerUtils = require_markerUtils();
    var _common = require_common();
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    ...
    var Marker = function(_React$Component) {
      ...
      function Marker2(props) {
        ...
        var _this = _possibleConstructorReturn(this, (Marker2.__proto__ || Object.getPrototypeOf(Marker2)).call(this, props));
        if (typeof window !== "undefined") {
          if (!props.__map__) {
      ...
      _createClass(Marker2, [{
        ...
        value: function createMarker(props) {
          ...
          this.marker.render = /* @__PURE__ */ function(marker) {
...
// node_modules/react-amap/lib/markers/index.js
var require_markers = __commonJS({
  "node_modules/react-amap/lib/markers/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var Markers = function(_Component) {
      _inherits(Markers2, _Component);
      function Markers2(props) {
        _classCallCheck(this, Markers2);
        var _this = _possibleConstructorReturn(this, (Markers2.__proto__ || Object.getPrototypeOf(Markers2)).call(this, props));
        if (typeof window !== "undefined") {
          if (!props.__map__) {
            _log2.default.warning("MAP_INSTANCE_REQUIRED");
          } else {
      ...
      _createClass(Markers2, [{
        ...
        value: function createMarkers(props) {
          ...
          markers.length && markers.forEach(function(raw, idx) {
            ...
            marker.render = /* @__PURE__ */ function(marker2) {
              return function(component) {
                return (0, _markerUtils.renderMarkerComponent)(component, marker2);
              };
            }(marker);
...
// node_modules/react-amap/lib/circle/index.js
var require_circle = __commonJS({
  "node_modules/react-amap/lib/circle/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var Circle = function(_React$Component) {
      ...
      function Circle2(props) {
        ...
        var _this = _possibleConstructorReturn(this, (Circle2.__proto__ || Object.getPrototypeOf(Circle2)).call(this, props));
        if (typeof window !== "undefined") {
          if (!props.__map__) {
            _log2.default.warning("MAP_INSTANCE_REQUIRED");
          } else {
      ...
      _createClass(Circle2, [{
        ...
        value: function buildCreateOptions(props) {
          ...
          allProps.forEach(function(key) {
            if (key in props) {
              if (key === "style" && props.style !== void 0) {
...
// node_modules/react-amap/lib/polyeditor/index.js
var require_polyeditor = __commonJS({
  "node_modules/react-amap/lib/polyeditor/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var PolyEditor = function(_React$Component) {
      _inherits(PolyEditor2, _React$Component);
      function PolyEditor2(props) {
        _classCallCheck(this, PolyEditor2);
        var _this = _possibleConstructorReturn(this, (PolyEditor2.__proto__ || Object.getPrototypeOf(PolyEditor2)).call(this, props));
        if (typeof window !== "undefined") {
...
// node_modules/react-amap/lib/polygon/index.js
var require_polygon = __commonJS({
  "node_modules/react-amap/lib/polygon/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _log = require_log();
    var _log2 = _interopRequireDefault(_log);
    var _polyeditor = require_polyeditor();
    ...
    var Polygon = function(_Component) {
      _inherits(Polygon2, _Component);
      function Polygon2(props) {
        _classCallCheck(this, Polygon2);
        var _this = _possibleConstructorReturn(this, (Polygon2.__proto__ || Object.getPrototypeOf(Polygon2)).call(this, props));
        if (typeof window !== "undefined") {
          if (!props.__map__) {
            _log2.default.warning("MAP_INSTANCE_REQUIRED");
          } else {
...
// node_modules/react-amap/lib/polyline/index.js
var require_polyline = __commonJS({
  "node_modules/react-amap/lib/polyline/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var Polyline = function(_Component) {
      _inherits(Polyline2, _Component);
      function Polyline2(props) {
        _classCallCheck(this, Polyline2);
        var _this = _possibleConstructorReturn(this, (Polyline2.__proto__ || Object.getPrototypeOf(Polyline2)).call(this, props));
        if (typeof window !== "undefined") {
          if (!props.__map__) {
            _log2.default.warning("MAP_INSTANCE_REQUIRED");
          } else {
...
// node_modules/react-amap/lib/infowindow/index.js
var require_infowindow = __commonJS({
  "node_modules/react-amap/lib/infowindow/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var InfoWindow = function(_Component) {
      _inherits(InfoWindow2, _Component);
      function InfoWindow2(props) {
        _classCallCheck(this, InfoWindow2);
        var _this = _possibleConstructorReturn(this, (InfoWindow2.__proto__ || Object.getPrototypeOf(InfoWindow2)).call(this, props));
        if (typeof window !== "undefined") {
          if (!props.__map__) {
            _log2.default.warning("MAP_INSTANCE_REQUIRED");
          } else {
...
// node_modules/react-amap/lib/groundimage/index.js
var require_groundimage = __commonJS({
  "node_modules/react-amap/lib/groundimage/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var GroundImage = function(_React$Component) {
      _inherits(GroundImage2, _React$Component);
      function GroundImage2(props) {
        _classCallCheck(this, GroundImage2);
        var _this = _possibleConstructorReturn(this, (GroundImage2.__proto__ || Object.getPrototypeOf(GroundImage2)).call(this, props));
        if (typeof window !== "undefined") {
          if (!props.__map__) {
            _log2.default.warning("MAP_INSTANCE_REQUIRED");
          } else {
      ...
      _createClass(GroundImage2, [{
        ...
        value: function createGroundImage(props) {
          var src = void 0, bounds = void 0, opacity = void 0, clickable = void 0;
          if ("src" in props) {
            src = props.src;
          } else {
...
// node_modules/react-amap/lib/circleeditor/index.js
var require_circleeditor = __commonJS({
  "node_modules/react-amap/lib/circleeditor/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var CircleEditor = function(_React$Component) {
      _inherits(CircleEditor2, _React$Component);
      function CircleEditor2(props) {
        _classCallCheck(this, CircleEditor2);
        var _this = _possibleConstructorReturn(this, (CircleEditor2.__proto__ || Object.getPrototypeOf(CircleEditor2)).call(this, props));
        if (typeof window !== "undefined") {
      ...
      return CircleEditor2;
    }(_react2.default.Component);
    exports.default = CircleEditor;
  }
});

// node_modules/react-amap/lib/mousetool/index.js
var require_mousetool = __commonJS({
  "node_modules/react-amap/lib/mousetool/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var MouseTool = function(_React$Component) {
      _inherits(MouseTool2, _React$Component);
      function MouseTool2(props) {
        _classCallCheck(this, MouseTool2);
        var _this = _possibleConstructorReturn(this, (MouseTool2.__proto__ || Object.getPrototypeOf(MouseTool2)).call(this, props));
        if (typeof window !== "undefined") {
          if (!props.__map__) {
            _log2.default.warning("MAP_INSTANCE_REQUIRED");
          } else {
...
// node_modules/react-amap/lib/index.js
var require_lib = __commonJS({
  "node_modules/react-amap/lib/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.MouseTool = exports.Marker = exports.GroundImage = exports.InfoWindow = exports.PolyEditor = exports.Polyline = exports.Polygon = exports.CircleEditor = exports.Circle = exports.Markers = exports.Map = void 0;
    var _map = require_map();
    var _map2 = _interopRequireDefault(_map);
    var _marker = require_marker();
    var _marker2 = _interopRequireDefault(_marker);
    var _markers = require_markers();
...
//# sourceMappingURL=react-amap.js.map
